        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            >
              ...
              <span>Review products, get paid. No investment required!</span>
            </motion.div>
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative bg-white rounded-3xl border border-gray-200/80 p-6 shadow-xl flex flex-col items-center">
              ...
              <div className="w-full text-left space-y-3">
                <span className="text-xxs font-bold text-amazon-blue uppercase tracking-wider">{activeProduct.category}</span>
                ...
                {/* Difficulty / Limit Indicators */}
                <div className="pt-2 flex items-center space-x-3 text-xxs font-semibold text-gray-500">
                  <span className="bg-gray-100 px-2 py-0.5 rounded">Difficulty: {activeProduct.difficulty || 'Easy'}</span>
                  <span className="bg-gray-100 px-2 py-0.5 rounded">Limit: {activeProduct.wordLimit || 50} words</span>
                </div>
